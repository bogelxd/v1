...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To BOGEL TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}BOGEL TUNNELING ® ${NC}${YELLOW}(${NC} ${green} YANG NYOLONG YATIM ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self BOGEL TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/bogelxd/v1/main/"
...
clear
izinsc="https://raw.githubusercontent.com/bogelxd/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/bogelxd_vpn"}]]}' 
...
wget -q https://raw.githubusercontent.com/bogelxd/v1/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
